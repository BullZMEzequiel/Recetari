        ...
        private suspend fun poblarRecetasPredefinidas(recetaDao: RecetaDao) {
            val recetasPredefinidas = listOf(
                Receta(
                    ...
                    categoria = "Sopa",
                    departamento = "La Paz",
                    imagenUri = "android.resource://com.example.recetarioboliviano/drawable/img_chairo"
                ),
                Receta(
                    titulo = "Sopa de Maní",
                    ...
                    imagenUri = "android.resource://com.example.recetarioboliviano/drawable/img_sopa_mani"
                ),
                Receta(
                    ...
                    categoria = "Segundo",
                    departamento = "Cochabamba",
                    imagenUri = "android.resource://com.example.recetarioboliviano/drawable/img_silpancho"
                ),
                Receta(
                    titulo = "Majadito",
                    tiempoPreparacion = "1h 15m",
                    ...
                    imagenUri = "android.resource://com.example.recetarioboliviano/drawable/img_majadito"
                ),
                Receta(
                    titulo = "Pique Macho",
                    ...
                    categoria = "Segundo",
                    departamento = "Cochabamba",
                    imagenUri = "android.resource://com.example.recetarioboliviano/drawable/img_pique_macho"
                ),
                Receta(
                    ...
                    imagenUri = "android.resource://com.example.recetarioboliviano/drawable/img_saltena"
                )
            )
